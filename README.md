...
Workspace with shared helper crates for TACEO MPC nodes.

## Crates

| Crate | Description |
|-------|-------------|
| [`taceo-nodes-common`](./nodes-common) | Common utilities: health API, PostgreSQL, Ethereum RPC, ERC-165, AWS secrets, graceful shutdown |
